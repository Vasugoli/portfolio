...
export type ProfileStage = 'intro' | 'projects' | 'contact'
        ...
        <code>
          ...
          {showProjects && (
            <>
              ...
              <span className="text-slate-400">: </span>
              <span className="text-sky-300">[</span>
              <span className="text-amber-200">"AI Risk Suite"</span>
              <span className="text-slate-400">, </span>
              <span className="text-amber-200">"Campus Lost &amp; Found"</span>
              <span className="text-slate-400">, </span>
              <span className="text-amber-200">"Food Bridge"</span>
              <span className="text-sky-300">]</span>
              <span className="text-slate-400">,</span>
              {'\n'}
            </>
          ...
          {showContact && (
            <>
              ...
              <span className="text-slate-400">: </span>
              <span className="text-amber-200">"you@example.com"</span>
              <span className="text-slate-400">,</span>
              {'\n'}
              {'    '}
              ...
              <span className="text-slate-400">: </span>
              <span className="text-amber-200">"https://linkedin.com"</span>
              {'\n'}
              {'  '}
              <span className="text-slate-400">{'}'}</span>
              <span className="text-slate-400">,</span>
